...
#ifndef DSPG_TIMED_EVENT_QUEUE_H_

#define DSPG_TIMED_EVENT_QUEUE_H_
...
struct DSPGTimedEventQueue {
    ...
    protected:
        virtual void fire(DSPGTimedEventQueue *queue, int64_t now_us) = 0;

    private:
        friend class DSPGTimedEventQueue;
...
private:
    ...
    struct StopEvent : public DSPGTimedEventQueue::Event {
    ...
    DSPGTimedEventQueue(const DSPGTimedEventQueue &);
    DSPGTimedEventQueue &operator=(const DSPGTimedEventQueue &);
};
