 ...
 * Filename         : DSPGAMPEG4AudioAssembler.cpp
 * Description      : Implemented based on android AMPEG4AudioAssembler.cpp
 *
 */
...
sp<ABuffer> DSPGAMPEG4AudioAssembler::removeLATMFraming(const sp<ABuffer> &buffer) {
...
DSPGAMPEG4AudioAssembler::DSPGAMPEG4AudioAssembler(
...
DSPGARTPAssembler::AssemblyStatus DSPGAMPEG4AudioAssembler::assembleMore(
...
DSPGARTPAssembler::AssemblyStatus DSPGAMPEG4AudioAssembler::addPacket(
        const sp<DSPGARTPSource> &source) {
...
void DSPGAMPEG4AudioAssembler::submitAccessUnit() {
...
void DSPGAMPEG4AudioAssembler::packetLost() {
...
void DSPGAMPEG4AudioAssembler::onByeReceived() {
    sp<AMessage> msg = mNotifyMsg->dup();
