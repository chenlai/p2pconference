 ...
 * Filename         : DSPGASessionDescription.cpp
 * Description      : Implemented based on android ASessionDescription.cpp
 *
 */
...
//#define LOG_NDEBUG 0
#define LOG_TAG "DSPGASessionDescription"
#include <utils/Log.h>
...
DSPGASessionDescription::DSPGASessionDescription()
    : mIsValid(false) {
}
...
bool DSPGASessionDescription::setTo(const void *data, size_t size) {
...
bool DSPGASessionDescription::parse(const void *data, size_t size) {
    mTracks.clear();
    mFormats.clear();
...
bool DSPGASessionDescription::isValid() const {
    return mIsValid;
}

size_t DSPGASessionDescription::countTracks() const {
    return mTracks.size();
}

void DSPGASessionDescription::getFormat(size_t index, AString *value) const {
    CHECK_GE(index, 0u);
...
bool DSPGASessionDescription::findAttribute(
...
void DSPGASessionDescription::getFormatType(
...
bool DSPGASessionDescription::getDimensions(
        size_t index, unsigned long PT,
...
bool DSPGASessionDescription::getDurationUs(int64_t *durationUs) const {
    *durationUs = 0;
...
// static
void DSPGASessionDescription::ParseFormatDesc(
...
// static
bool DSPGASessionDescription::parseNTPRange(
