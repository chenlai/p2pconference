 ...
 * Filename         : DSPGASessionDescription.h
 * Description      : Implemented based on android ASessionDescription.h
 *
 */
...
#ifndef DSPG_A_SESSION_DESCRIPTION_H_

#define DSPG_A_SESSION_DESCRIPTION_H_
...
struct DSPGASessionDescription : public RefBase {
    DSPGASessionDescription();
...
protected:
    virtual ~DSPGASessionDescription();
...
private:
    ...
    DISALLOW_EVIL_CONSTRUCTORS(DSPGASessionDescription);
};
