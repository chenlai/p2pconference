 ...
 * Filename         : DSPGAAMRAssembler.cpp
 * Description      : Implemented based on android AAMRAssembler.cpp
 *
 */
...
//#define LOG_NDEBUG 0
#define LOG_TAG "DSPGAAMRAssembler"
#include <utils/Log.h>
...
DSPGAAMRAssembler::DSPGAAMRAssembler(
...
DSPGARTPAssembler::AssemblyStatus DSPGAAMRAssembler::assembleMore(
...
DSPGARTPAssembler::AssemblyStatus DSPGAAMRAssembler::addPacket(
        const sp<DSPGARTPSource> &source) {
...
void DSPGAAMRAssembler::packetLost() {
    CHECK(mNextExpectedSeqNoValid);
    ++mNextExpectedSeqNo;
}

void DSPGAAMRAssembler::onByeReceived() {
    sp<AMessage> msg = mNotifyMsg->dup();
