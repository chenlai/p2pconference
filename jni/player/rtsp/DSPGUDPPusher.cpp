 ...
 * Filename         : DSPGUDPPusher.cpp
 * Description      : Implemented based on android UDPPusher.cpp
 *
 */
...
DSPGUDPPusher::DSPGUDPPusher(const char *filename, unsigned port)
...
void DSPGUDPPusher::onMessageReceived(const sp<AMessage> &msg) {
    switch (msg->what()) {
        case kWhatPush:
        {
