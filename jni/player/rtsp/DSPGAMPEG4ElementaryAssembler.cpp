 ...
 * Filename         : DSPGAMPEG4ElementaryAssembler.cpp
 * Description      : Implemented based on android AMPEG4ElementaryAssembler.cpp
 *
 */
...
//#define LOG_NDEBUG 0
#define LOG_TAG "DSPGAMPEG4ElementaryAssembler"
#include <utils/Log.h>
...
// static
DSPGAMPEG4ElementaryAssembler::DSPGAMPEG4ElementaryAssembler(
...
DSPGARTPAssembler::AssemblyStatus DSPGAMPEG4ElementaryAssembler::addPacket(
...
void DSPGAMPEG4ElementaryAssembler::submitAccessUnit() {
...
DSPGARTPAssembler::AssemblyStatus DSPGAMPEG4ElementaryAssembler::assembleMore(
        const sp<DSPGARTPSource> &source) {
...
void DSPGAMPEG4ElementaryAssembler::packetLost() {
...
void DSPGAMPEG4ElementaryAssembler::onByeReceived() {
    sp<AMessage> msg = mNotifyMsg->dup();
