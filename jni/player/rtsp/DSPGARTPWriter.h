 ...
 * Filename         : DSPGARTPWriter.h
 * Description      : Implemented based on android ARTPWriter.h
 *
 */
...
#ifndef DSPG_A_RTP_WRITER_H_

#define DSPG_A_RTP_WRITER_H_
...
struct DSPGARTPWriter : public MediaWriter {
    DSPGARTPWriter(int fd);
...
private:
    ...
    sp<ALooper> mLooper;
    sp<AHandlerReflector<DSPGARTPWriter> > mReflector;
    ...
    DISALLOW_EVIL_CONSTRUCTORS(DSPGARTPWriter);
};

}  // namespace android

#endif  // DSPG_A_RTP_WRITER_H_
