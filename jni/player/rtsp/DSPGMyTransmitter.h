 ...
 * Filename         : DSPGMyTransmitter.h
 * Description      : Implemented based on android MyTransmitter.h
 *
 */
...
#ifndef DSPG_MY_TRANSMITTER_H_

#define DSPG_MY_TRANSMITTER_H_
...
struct DSPGMyTransmitter : public AHandler {
    DSPGMyTransmitter(const char *url, const sp<ALooper> &looper)
        : mServerURL(url),
          mLooper(looper),
...
private:
    ...
    DISALLOW_EVIL_CONSTRUCTORS(DSPGMyTransmitter);
};
